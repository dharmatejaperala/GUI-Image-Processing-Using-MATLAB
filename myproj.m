function varargout = teja_test(varargin)
% Begin initialization code
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @teja_test_OpeningFcn, ...
                   'gui_OutputFcn',  @teja_test_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before teja_test is made visible.
function teja_test_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for teja_test
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes teja_test wait for user response (see UIRESUME)
...
function varargout = teja_test_OutputFcn( hObject, eventdata, handles)
...
axes(handles.axes1);
imshow(image)
savename = strcat('C:\Users\tejap\Documents\my project\dummy6y\' ,num2str(counter), '.jpg'); %this is where and what your image will be saved
